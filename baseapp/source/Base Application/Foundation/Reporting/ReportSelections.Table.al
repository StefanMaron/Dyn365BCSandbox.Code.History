...
table 77 "Report Selections"
{
    ...
    [IntegrationEvent(false, false)]
    procedure OnBeforSaveReportAsPDF(var TempBlob: Codeunit "Temp Blob"; ReportID: Integer; RecordVariant: Variant; LayoutCode: Code[20]; ReportUsage: Enum "Report Selection Usage"; var Handled: Boolean)
    begin
    end;
}
