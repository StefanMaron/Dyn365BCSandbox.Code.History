...
codeunit 1032 "Job Planning Line-Reserve"
{
    ...
    begin
        ...
        OnSetSourceForReservationOnBeforeUpdateReservation(ReservEntry, JobPlanningLine);
#if not CLEAN25
        sender.RunOnSetJobPlanningLineOnBeforeUpdateReservation(ReservEntry, JobPlanningLine);
#endif
        sender.UpdateReservation((CreateReservEntry.SignFactor(ReservEntry) * JobPlanningLine."Remaining Qty. (Base)") <= 0);
    end;
