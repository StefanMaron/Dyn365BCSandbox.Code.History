...
codeunit 926 "Assembly Line-Reserve"
{
    ...
    begin
        ...
        OnSetSourceForReservationOnBeforeUpdateReservation(ReservEntry, AssemblyLine);
#if not CLEAN25
        sender.RunOnSetAssemblyLineOnBeforeUpdateReservation(ReservEntry, AssemblyLine);
#endif
        sender.UpdateReservation((CreateReservEntry.SignFactor(ReservEntry) * AssemblyLine."Remaining Quantity (Base)") <= 0);
    end;
