...
#if not CLEAN25
        sender.RunOnSetAssemblyHeaderOnBeforeUpdateReservation(ReservEntry, AssemblyHeader);
#endif
        sender.UpdateReservation((CreateReservEntry.SignFactor(ReservEntry) * AssemblyHeader."Remaining Quantity (Base)") < 0);
    end;
