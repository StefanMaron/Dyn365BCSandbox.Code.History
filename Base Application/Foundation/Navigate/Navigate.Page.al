...
#pragma warning restore AA0470
    ...
    begin
        ...
        if PaymentHeader.ReadPermission then begin
            ...
            Rec.InsertIntoDocEntry(DATABASE::"Payment Header", PaymentHeader.TableCaption(), PaymentHeader.Count);
        end;
        if PaymentLine.ReadPermission then begin
            ...
            Rec.InsertIntoDocEntry(DATABASE::"Payment Line", PaymentLine.TableCaption(), PaymentLine.Count);
        end;
        if PaymentHeaderArchive.ReadPermission then begin
            ...
            Rec.InsertIntoDocEntry(DATABASE::"Payment Header Archive", PaymentHeaderArchive.TableCaption(), PaymentHeaderArchive.Count);
        end;
        if PaymentLineArchive.ReadPermission then begin
            ...
            Rec.InsertIntoDocEntry(DATABASE::"Payment Line Archive", PaymentLineArchive.TableCaption(), PaymentLineArchive.Count);
        end;
