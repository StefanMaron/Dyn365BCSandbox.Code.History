...
#pragma warning restore AA0470
    ...
    begin
        ...
        if GSTPurchEntry.ReadPermission() then begin
            ...
            Rec.InsertIntoDocEntry(Database::"GST Purchase Entry", GSTPurchEntry.TableCaption(), GSTPurchEntry.Count);
        end;
        if GSTSalesEntry.ReadPermission() then begin
            ...
            Rec.InsertIntoDocEntry(Database::"GST Sales Entry", GSTSalesEntry.TableCaption(), GSTSalesEntry.Count);
        end;
        if WHTEntry.ReadPermission() then begin
            ...
            Rec.InsertIntoDocEntry(Database::"WHT Entry", WHTEntry.TableCaption(), WHTEntry.Count);
        end;
