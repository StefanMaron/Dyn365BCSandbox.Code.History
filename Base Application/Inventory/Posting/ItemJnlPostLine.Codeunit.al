...
#pragma warning restore AA0074
    ...
    /// <summary>
    /// Checks the tracking information of an item journal. If lot or serial numbers are required but are missing, an error is thrown.
    /// </summary>
    /// <remarks>
    /// If the journal line is a transfer, it also checks for new serial and lot numbers to be assigned during the posting.
    /// </remarks>
