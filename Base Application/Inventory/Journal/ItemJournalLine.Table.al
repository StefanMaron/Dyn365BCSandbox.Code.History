...
#pragma warning restore AA0074
    ...
    /// <summary>
    /// Clears the tracking information (serial number and lot number) of an item journal line.
    /// </summary>
    ...
    /// <summary>
    /// Copies tracking information (serial number and lot number) from a reservation entry to an item journal line.
    /// </summary>
    ...
    /// <summary>
    /// Copies tracking information (serial number and lot number) from a item ledger entry to an item journal line.
    /// </summary>
    ...
    /// <summary>
    /// Copies tracking information (serial number and lot number) from a tracking specification to an item journal line.
    /// </summary>
    ...
    /// <summary>
    /// Set tracking information (serial number and lot number) filter from a item ledger entry to an item journal line.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the current item journal line has the same serial and lot numbers as the new serial and lot numbers.
    /// </summary>
    /// <returns>True if the tracking information is the same, otherwise false.</returns>
    ...
    /// <summary>
    /// Tests if the tracking information (serial number and lot number) in the item journal line is empty.
    /// </summary>
    ...
    /// <summary>
    /// Tests if the tracking information (serial number and lot number) in the item journal line is equal to the 
    ...
    /// <summary>
    /// Tests if the tracking information (serial number and lot number) of the item journal line are filled if 
