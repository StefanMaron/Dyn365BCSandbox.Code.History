...
codeunit 7201 "CDS Integration Impl."
{
    ...
    internal procedure GetTempConnectionSetup(var TempCDSConnectionSetup: Record "CDS Connection Setup" temporary; var CDSConnectionSetup: Record "CDS Connection Setup"; AccessToken: SecretText);
    var
        EmptySecretText: SecretText;
    begin
