...
#pragma warning restore AA0074
    ...
    begin
        ...
        OnSetSourceForReservationOnBeforeUpdateReservation(ReservEntry, ProdOrderComp);
#if not CLEAN25
        sender.RunOnSetProdOrderCompOnBeforeUpdateReservation(ReservEntry, ProdOrderComp);
#endif
        sender.UpdateReservation(ProdOrderComp."Remaining Qty. (Base)" > 0);
    end;
