...
#pragma warning restore AA0074
    ...
    begin
        ...
        OnSetSourceForReservationOnBeforeUpdateReservation(ReservEntry, ProdOrderLine);
#if not CLEAN25
        sender.RunOnSetProdOrderLineOnBeforeUpdateReservation(ReservEntry, ProdOrderLine);
#endif
        sender.UpdateReservation(ProdOrderLine."Remaining Qty. (Base)" < 0);
    end;
