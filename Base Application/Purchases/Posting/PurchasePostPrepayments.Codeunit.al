...
#pragma warning restore AA0074
        ...
        case DocumentType of
            DocumentType::Invoice:
                begin
                    ...
                    PaymentTerms.Get(PurchHeader."Prepmt. Payment Terms Code");
                    PaymentTerms.VerifyMaxNoDaysTillDueDate(PurchHeader."Prepayment Due Date", PurchHeader."Document Date", PurchHeader.FieldCaption("Prepayment Due Date"));
                ...
                if NewAmount <> 0 then begin
                    ...
                    then
                        VATAmountLine.InsertNewLine(
                          ...
                          PurchLine."Prepayment VAT %", NewAmount >= 0, true, PurchLine."Prepayment EC %", 0);
        ...
        if FromPurchLine.Find('-') then begin
            ...
            if PurchSetup."Invoice Rounding" then begin
                ...
                if InitInvoiceRoundingLine(PurchHeader, TotalAmt, InvRoundingPurchLine) then begin
                    ...
                    ToPurchLine."Prepayment EC %" := ToPurchLine."EC %";
                    ToPurchLine.Insert();
                end;
            end;
        end;
    ...
    begin
        ...
        if PurchHeader."Generate Autoinvoices" or PurchLine.FindFirst() then begin
    ...
    begin
        ...
        PurchLine.SetRange("Document No.", PurchHeader."No.");
        PurchLine.SetRange("VAT Calculation Type", PurchLine."VAT Calculation Type"::"Reverse Charge VAT");
        if PurchHeader."Generate Autocredit Memo" or PurchLine.FindFirst() then begin
    ...
    begin
        ...
        PurchInvLine."EC %" := PrepmtInvLineBuffer."EC %";
    ...
    begin
        ...
        PurchCrMemoLine."EC %" := PrepmtInvLineBuffer."EC %";
