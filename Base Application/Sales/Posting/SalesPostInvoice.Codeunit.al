...
codeunit 815 "Sales Post Invoice" implements "Invoice Posting"
{
    ...
    begin
        ...
        InvoicePostingBuffer."Deductible %" := SalesLine."Deductible %";
        InvoicePostingBuffer."VAT Identifier" := SalesLine."VAT Identifier";
        InvoicePostingBuffer."Include in VAT Transac. Rep." := SalesLine."Include in VAT Transac. Rep.";
        InvoicePostingBuffer."Refers to Period" := SalesLine."Refers to Period";
        InvoicePostingBuffer."Contract No." := SalesLine."Blanket Order No.";
    ...
    begin
        ...
        CustLedgerEntry2.CalcSums("Remaining Pmt. Disc. Possible");
        TotalRemainPmtDiscPossible := CustLedgerEntry2."Remaining Pmt. Disc. Possible";
        ...
        SetAmountsForBalancingEntry(SalesHeader, CustLedgerEntry2, GenJournalLine, TotalRemainPmtDiscPossible);
    ...
    local procedure SetAmountsForBalancingEntry(SalesHeader: Record "Sales Header"; var CustLedgerEntry: Record "Cust. Ledger Entry"; var GenJnlLine: Record "Gen. Journal Line"; TotalRemainPmtDiscPossible: Decimal)
    var
        PaymentMethod: Record "Payment Method";
        IsHandled: Boolean;
    begin
