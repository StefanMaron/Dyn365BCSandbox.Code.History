...
#pragma warning restore AA0005
    ...
    begin
        ...
        GenJnlLine."Pmt. Discount Given/Rec. (LCY)" := -TotalSalesLineLCY2."Pmt. Discount Amount";
        ...
        GenJnlLine."Issued By Third Party" := SalesHeader."Issued By Third Party";
        GenJnlLine.SetSIIFirstSummaryDocNo(SalesHeader.GetSIIFirstSummaryDocNo());
        GenJnlLine.SetSIILastSummaryDocNo(SalesHeader.GetSIILastSummaryDocNo());

        GenJnlLine."Do Not Send To SII" := SalesHeader."Do Not Send To SII";
