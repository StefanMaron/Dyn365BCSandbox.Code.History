...
codeunit 99000839 "Sales Get Demand To Reserve"
{
    ...
    begin
        ...
        if SalesLine.FindSet() then
            repeat
                ...
                IsHandled := false;
                OnSalesOrderLineOnAfterGetRecordOnBeforeSetTempSalesLine(SalesLine, IsHandled);
#if not CLEAN25
    ...
    local procedure OnSalesOrderLineOnAfterGetRecordOnBeforeSetTempSalesLine(var SalesLine: Record "Sales Line"; var IsHandled: Boolean)
    begin
    end;
}