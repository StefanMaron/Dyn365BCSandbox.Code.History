...
codeunit 99000799 "Mfg. Experience Tier"
{
    Access = Internal;
    ...
    var
        MfgExperienceTier: Codeunit "Serv. Experience Tier";
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Experience Tier", 'OnCheckExperienceTierOnBindSubscriptions', '', false, false)]
    local procedure OnCheckExperienceTierOnBindSubscriptions()
    begin
