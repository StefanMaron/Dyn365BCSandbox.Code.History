...
#pragma warning restore AA0074
    ...
    begin
        ...
        OnSetSourceForReservationOnBeforeUpdateReservation(ReservEntry, PlanningComponent);
#if not CLEAN25
        sender.RunOnSetPlanningCompOnBeforeUpdateReservation(ReservEntry, PlanningComponent);
#endif
        sender.UpdateReservation(PlanningComponent."Net Quantity (Base)" > 0);
    end;
