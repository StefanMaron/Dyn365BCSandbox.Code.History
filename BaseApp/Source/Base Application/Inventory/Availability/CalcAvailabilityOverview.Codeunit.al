...
#pragma warning restore AA0074
    ...
    begin
        InsertAvailabilityEntry(
            ...
            NewSourceType, NewSourceOrderStatus, NewSourceID, NewDescription, "Demand Order Source Type".FromInteger(NewDemandType));
    end;
#endif
    ...
    begin
        SetParameters("Demand Order Source Type".FromInteger(NewDemandType), NewDemandNo);
    end;
#endif

    procedure SetParameters(NewDemandType: Enum Microsoft.Inventory.Requisition."Demand Order Source Type"; NewDemandNo: Code[20])
    begin
