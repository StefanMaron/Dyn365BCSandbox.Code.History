...
codeunit 7287 SalesOrderLookup implements DocumentLookupSubType
{
    ...
    var
        NoDocumentFound1Err: Label 'Copilot could not find the requested Sales Order for %1. Please rephrase the description and try again.', Comment = '%1 = Customer Name';
        NoDocumentFound2Err: Label 'Copilot could not find the requested Sales Order %1. Please rephrase the description and try again.', Comment = '%1 = Document No.';
        NoLinesFoundInTheDocumentErr: Label 'Copilot found the Sales Order %1, but it does not have any relevant lines.', Comment = '%1 = Document No.';
    ...
    begin
        ...
        if FoundDocNo <> '' then
            ...
            if SourceSalesHeader."Document Type" = SalesHeader."Document Type"::Order then
