codeunit 137287 "SCM Inventory Costing II"
{
    ...
    begin
        ...
        repeat
            PurchaseLine.Validate("Qty. to Receive", PurchaseLine.Quantity * QtyToReceiveCoeff);
            PurchaseLine.Validate("Qty. to Invoice", PurchaseLine.Quantity * QtyToInvoiceCoeff);
            PurchaseLine.Modify(true);
    ...
    begin
        ...
        SalesLine.FindSet();
        repeat
            SalesLine.Validate("Qty. to Ship", SalesLine.Quantity * QtyToShipCoeff);
            SalesLine.Validate("Qty. to Invoice", SalesLine.Quantity * QtyToInvoiceCoeff);
            SalesLine.Modify(true);
