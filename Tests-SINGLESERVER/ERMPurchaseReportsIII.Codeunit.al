codeunit 134988 "ERM Purchase Reports III"
{
    ...
    begin
        ...
        LibraryReportValidation.OpenExcelFile();
        LibraryReportValidation.VerifyCellValue(105, 15, LibraryReportValidation.FormatDecimalValue(VATEntry.Base));
        LibraryReportValidation.VerifyCellValue(105, 27, LibraryReportValidation.FormatDecimalValue(VATEntry.Amount));
    end;
